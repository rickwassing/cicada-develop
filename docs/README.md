...
We use [semantic versioning](http://semver.org/). Current version is 0.1.7. Cicada is still in development and currently ONLY works in Matlab 2019b. Anything may change at any time and the software should not be considered stable.
