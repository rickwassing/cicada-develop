...
for s = 1:size(slpWindows,1)
    ...
    slpPeriod = selectEventsUsingTime(ACT.analysis.events, slpWindows.onset(s), slpWindows.onset(s)+slpWindows.duration(s), ...
        'Label', 'sleepPeriod', ...
        'Type', slpPeriodType);
    % ---------------------------------------------------------
    ...
    waso = selectEventsUsingTime(ACT.analysis.events, slpWindows.onset(s), slpWindows.onset(s)+slpWindows.duration(s), ...
        'Label', 'waso', ...
        'Type', slpPeriodType);
