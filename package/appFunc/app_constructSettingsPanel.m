...
if shouldComponentMount(app, app.GridLayoutSettingsPanel, 'AnnotationTypePanel')
    ...
    props = { ...
        ...
        'Visible', ifelse(any(app.ACT.analysis.annotate.acceleration.Data ~= 0), 'on', 'off'); ...
        'Layout',  Layout; ...
...
if shouldComponentMount(app, app.GridLayoutSettingsPanel, 'SleepWindowTypePanel')
    ...
    props = { ...
        ...
        'Visible', ifelse(any(strcmpi(app.ACT.events.label, 'sleepWindow')), 'on', 'off'); ...
        'Layout',  Layout; ...
...
if shouldComponentMount(app, parent, 'SleepWindowTypeInput')
    ...
    Layout.Column = 1;
    % Set items
    Items = unique(app.ACT.events.type(strcmpi(app.ACT.events.label, 'sleepWindow')));
...
if shouldComponentMount(app, app.GridLayoutSettingsPanel, 'DeleteEventsPanel')
    ...
    props = { ...
        ...
        'Visible', ifelse(any(strcmpi(app.ACT.events.type, 'customEvent')), 'on', ifelse(any(strcmpi(app.ACT.events.label, 'reject')), 'on', 'off')); ...
        'Layout',  Layout; ...
...
if shouldComponentMount(app, parent, 'DeleteEventsInput')
	...
	UserData.input = 'na';
    % Set Items
    Items = [{'Select ...'}; unique(app.ACT.events.label(strcmpi(app.ACT.events.type, 'customEvent') | strcmpi(app.ACT.events.label, 'reject')))];
    % Define the properties
    props = {
