...
if shouldComponentMount(app, app.GridLayoutSettingsPanel, 'SleepWindowTypePanel')
    ...
    props = { ...
        ...
        'Visible', ifelse(any(strcmpi(app.ACT.analysis.events.label, 'sleepWindow')), 'on', 'off'); ...
        'Layout',  Layout; ...
...
if shouldComponentMount(app, parent, 'SleepWindowTypeInput')
    ...
    Layout.Column = 1;
    % Set items
    Items = unique(app.ACT.analysis.events.type(strcmpi(app.ACT.analysis.events.label, 'sleepWindow')));
...
if shouldComponentMount(app, app.GridLayoutSettingsPanel, 'DeleteEventsPanel')
    ...
    parent = constructComponent(app, 'DeleteEventsPanel', app.GridLayoutSettingsPanel, { ...
        'Layout',  Layout; ...
        'Visible', ifelse(any(ismember(app.ACT.analysis.events.type, {'customEvent', 'reject'})), 'on', 'off'); ...
        });
end
% -----
% UIGridLayout
