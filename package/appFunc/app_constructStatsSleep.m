...
if shouldComponentMount(app, GridLayoutContainer, 'SleepStats_UIAxesOverview')
    ...
    props = { ...
        ...
        'XTickLabel', cellfun(@(pre, post) [titleCase(pre), ' #', post], app.ACT.stats.sleep.actigraphy.slpType, cellstr(num2str(app.ACT.stats.sleep.actigraphy.slpCount)), 'UniformOutput', false); ...
        'YDir', 'reverse'; ...
        'YGrid', 'on'; ...
        'GridAlpha', 0.33; ...
...
for si = 1:size(app.ACT.stats.sleep.actigraphy, 1)
    ...
    if shouldComponentMount(app, SleepStats_GridLayoutContainerPanel, ['SleepStats_Panel-', num2str(si)])
        ...
        props = {...
            ...
            'Title', [ifelse(strcmpi(app.ACT.stats.sleep.actigraphy.slpType{si}, 'night'), 'Sleep', 'Nap'), ' Window #', num2str(app.ACT.stats.sleep.actigraphy.slpCount(si))]; ...
            'FontSize', 8; ...
            'FontWeight', 'bold'; ...
            'Layout', Layout; ...
