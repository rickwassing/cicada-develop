...
if ismember('Info', app.ComponentList)
    ...
    app.Components = [app.Components; ...
        ...
        app.HeightLabel,          {'Text', ifelse((isnan(app.ACT.info.height) | isempty(app.ACT.info.height)), '- cm', [num2str(app.ACT.info.height), ' cm'])}; ...
        app.WeightLabel,          {'Text', ifelse((isnan(app.ACT.info.weight) | isempty(app.ACT.info.weight)), '- kg', [num2str(app.ACT.info.weight), ' kg'])}; ...
...
if ismember('Menu', app.ComponentList)
    app.Components = [app.Components; ...
        ...
        app.SaveDatasetAsMenu,      {'Enable', app.Menu.SaveDatasetAsMenu.Enable}; ...
