...
for di = 1:size(app.ACT.stats.daily, 1)
    for varName = {'MinEuclNormMovWin5h', 'MaxEuclNormMovWin10h'}
        ...
        if ~strcmpi(XData, 'na')
            ...
            if shouldComponentMount(app, parent, ['DailyStats_Plot' varName{:} '_day-', num2str(di)])
                ...
                props = {...
                    ...
                    'LineStyle', '-'; ...
                    'LineWidth', 1; ...
                    'Marker', ifelse(strcmpi(varName{:}, 'MinEuclNormMovWin5h'), 'v', '^'); ...
                    'Color', ifelse(strcmpi(varName{:}, 'MinEuclNormMovWin5h'), [0.0936, 0.3909, 0.6030], [0.4983, 0.0222, 0.1202]); ...
                    'MarkerFaceColor', ifelse(strcmpi(varName{:}, 'MinEuclNormMovWin5h'), [0.3059, 0.5805, 0.7765], [0.7059, 0.1490, 0.2636]); ...
                    'MarkerEdgeColor', ifelse(strcmpi(varName{:}, 'MinEuclNormMovWin5h'), [0.0936, 0.3909, 0.6030], [0.4983, 0.0222, 0.1202]); ...
                    };
            ...
            if shouldComponentMount(app, parent, ['DailyStats_Text' varName{:} '_day-', num2str(di)])
                ...
                props = { ...
                    ...
                    'FontWeight', 'bold'; ...
                    'Color', 'w'; ...
                    'VerticalAlignment', ifelse(strcmpi(varName{:}, 'MinEuclNormMovWin5h'), 'bottom', 'top'); ...
                    'HorizontalAlignment', 'center'; ...
                    'BackgroundColor', ifelse(strcmpi(varName{:}, 'MinEuclNormMovWin5h'), [0.0936, 0.3909, 0.6030], [0.4983, 0.0222, 0.1202]); ...
...
for fi = 1:length(fnames)
    ...
    switch fnames{fi}
        ...
        case 'maxEuclNormMovWin10h'
            Text = ifelse(isnan(value), '-', sprintf('%.0f mg', value*1000));
            Color = [0.49, 0.18, 0.56];
        case 'clockOnsetMaxEuclNormMovWin10h'
